...
import com.example.android.thesunapp.WeatherContract;
import com.example.android.thesunapp.SunshineDateUtils;
import com.example.android.thesunapp.SunshineWeatherUtils;
...
//      COMPLETED (35) Initialize the loader for DetailActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.detailfile, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.detail_setting_action) {
            startActivity(new Intent(this, SettingsActivity.class));
            return true;
        }

        /* Share menu item clicked */
        if (id == R.id.share_detail_action) {
