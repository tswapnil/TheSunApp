...
public class SunshinePreferences {
    ...
    /**
     * Helper method to handle setting location details in SunshinePreferences (City Name, Latitude,
     * Longitude)
     *
    ...
    /**
     * Returns the location currently set in SunshinePreferences. The default location this method
