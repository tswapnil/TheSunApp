...
private static final UriMatcher sUriMatcher = buildUriMatcher();
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection,
        ...
        switch(match){
            case CODE_WEATHER:
                retCursor = db.query(WeatherContract.WeatherEntry.TABLE_NAME,projection,selection,selectionArgs,null,null,sortOrder);
            ...
            case CODE_WEATHER_WITH_DATE:
                ...
                retCursor = db.query(WeatherContract.WeatherEntry.TABLE_NAME,projection,mSelection,mSelectionArgs,null,null,sortOrder);
                break;
